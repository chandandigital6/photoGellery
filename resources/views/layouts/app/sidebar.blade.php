    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="photo" :href="route('image.tool')" :current="request()->routeIs('image.tool')"
                    wire:navigate>
                    {{ __('Image Tool') }}
                </flux:sidebar.item>

                <flux:navlist.item icon="chart-bar" :href="route('admin.usage.index')"
                    :current="request()->routeIs('admin.usage.*')" wire:navigate>
                    Usage Dashboard
                </flux:navlist.item>
